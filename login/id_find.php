                ...
                <div class="mx-4 sm:mx-0">
                    ...
                    <div class="relative mt-7">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <h2 class="px-2 text-orange-500 bg-white">아이디 찾기</h2>
                        </div>
                    </div>
                    <form class="mt-8 space-y-6" name="find" method="post" action="find.php">
                        <div class="space-y-6 rounded-md shadow-sm">
                            <div><label for="name" class="block text-sm font-medium text-gray-700">이름</label>
                                <div class="mt-1"><input id="name" type="text" placeholder="이름을 입력하세요"
                        ...
                        <div class="flex items-center justify-end">
                            <div class="ml-4 space-x-2 text-sm">
                                <a class="text-orange-500 hover:text-orange-400" href="./pw_find.php">패스워드 찾기</a>
                            </div>
                        </div>
                        <button type="button" 
                            class="relative flex justify-center w-full px-4 py-2 mt-8 text-sm font-medium text-white bg-orange-500 border border-transparent rounded-md find hover:bg-orange-600 focus:outline-none">아이디
                            찾기</button>
                        <p class="flex items-center justify-center space-x-1 text-sm text-gray-500"><span>아이디가
                                기억나셨나요?</span><a
